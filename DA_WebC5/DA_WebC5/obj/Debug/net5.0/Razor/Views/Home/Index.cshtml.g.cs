#pragma checksum "C:\Users\Hung\Documents\FPT Polytechnic\LAP_TRINH_C Sharp 5\DuAn_WebC5-07-05-24-\DA_WebC5\DA_WebC5\Views\Home\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "419220acc396da5a6bd836fad9bee7e373f060356aecc8a1ee4d021791e49074"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"419220acc396da5a6bd836fad9bee7e373f060356aecc8a1ee4d021791e49074", @"/Views/Home/Index.cshtml")]
...
<div id=""carouselExampleAutoplaying"" class=""carousel slide"" data-bs-ride=""carousel"" data-bs-interval=""3000"">
    <div class=""carousel-inner"">
        <div class=""carousel-item active"">
            <!-- I");
            WriteLiteral(@"mage with no mask -->
            <div class=""bg-image"">
                ...
                <div class=""mask"">
                    <div class=""bottom-0 d-flex align-items-center h-100 text-center justify-content-start"">
                        <div class=""col-md-12 col-lg-5"">
                            ...
                            <div class=""position-relative mx-auto"">
                                <button type=""submit""
                                        class=""btn btn btn-dark b");
            WriteLiteral(@"order-2 border-secondary position-absolute rounded-pill text-white h-auto w-45""
                                        style=""left: 37%;"">
                                    Explore now
                                    <i class=""bi bi-search""></i>
                                </button>
    ...
    <button class=""carousel-con");
            WriteLiteral(@"trol-next"" type=""button"" data-bs-target=""#carouselExampleAutoplaying"" data-bs-slide=""next"">
        ...
        <div class=""row g-4"">
                ...
                <div class=""features-item text-center rounded bg-light p-4"">
                    <div class=""card"">
                        ...
                        <div class=""card-body"">
                            ...
                            <p class=""card-text"">On orders over $50.0");
            WriteLiteral(@"0</p>
                        </div>
                    </div>
                </div>
           ...
           ");
            ...
            <div class=""col-md-6 col-lg-3"">
                <div class=""features-item text-center rounded bg-light p-4"">
                    <div class=""card"">
                        <img src=""https://img.freepik.com/free-vector/call-center-agent-concept-flat-style_23-2147947654.jpg?t=st=1716138278~exp=1716141878~hmac=25f365cdc8d95ca01b0a0fd7891e9782365c4c94741f877c4fc98");
            WriteLiteral(@"2a490e4c03f&w=740"" class=""card-img-top""
                             alt=""24/7 support"" />
                        <div class=""card-body"">
        ...
        <div class=""col-sm-4"">
            <div class=""card"">
                <div class=""p-3 mb-2 bg-info-subtle text-dark"">
                    <div class=""card-body"">
           ");
            WriteLiteral(@"             <h5 class=""card-title"">Phụ kiện</h5>
            ...
            <div class=""row"">
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    <div class=""border border-secondary-subtle rounded"">
                        <div class=""d-flex justify-content-end m-2""><i class=""btn btn-outline-dark bi bi-b");
            WriteLiteral(@"ag-fill""></i></div>
                ...
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    <div class=""border border-secondary-subtle rounded"">
                        <div class=""d-flex justify-content-end m-2""><i class=""btn btn-outline-dark bi bi-bag-fill");
            WriteLiteral(@"""></i></div>
                        <div><img src=""https://product.hstatic.net/1000341630/product/prematch-07_58796c34b2054d5cbed1f4f8061770ee_master.jpg"" alt=""Alternate Text"" class=""mw-100"" /></div>
                    </div>
                    <div class=""row container-fluid"">
                ...
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    <div class=""border border-secondary-subtle rounded"">
                        <div class=""d-flex justify-content-end m-2""><i class=""btn btn-outline-dark bi bi-bag-fill""></i><");
            WriteLiteral(@"/div>
                        <div><img src=""https://product.hstatic.net/1000341630/product/prematch-07_58796c34b2054d5cbed1f4f8061770ee_master.jpg"" alt=""Alternate Text"" class=""mw-100"" /></div>
                    </div>
                    <div class=""row container-fluid"">
...
");
            WriteLiteral(@"                        <div><img src=""https://product.hstatic.net/1000341630/product/prematch-07_58796c34b2054d5cbed1f4f8061770ee_master.jpg"" alt=""Alternate Text"" class=""mw-100"" /></div>
                    </div>
                    <div class=""row container-fluid"">
                        <p class=""font-weight-bold col-sm-8 mb-1"">Áo cầu lông 1</p>
                        <p class=""font-weight-bold col-sm-4 mb-1"">200.000</p>
        ...
        <div class=""container py-3"">
            ...
            WriteLiteral(@"d-flex justify-content-end m-2""><i class=""btn btn-outline-dark bi bi-bag-fill""></i></div>
                ...
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    <div class=""border border-secondary-subtle rounded"">
                        <div class=""d-flex ");
            WriteLiteral(@"justify-content-end m-2""><i class=""btn btn-outline-dark bi bi-bag-fill""></i></div>
                        <div><img src=""https://product.hstatic.net/1000341630/product/prematch-07_58796c34b2054d5cbed1f4f8061770ee_master.jpg"" alt=""Alternate Text"" class=""mw-100"" /></div>
                    </div>
                    <div class=""row container-fluid"">
                        <p class=""font-weight-bold col-sm-8 mb-1"">Áo cầu lông 1</p>
            ...
            WriteLiteral(@"-content-end m-2""><i class=""btn btn-outline-dark bi bi-bag-fill""></i></div>
                        <div><img src=""https://product.hstatic.net/1000341630/product/prematch-07_58796c34b2054d5cbed1f4f8061770ee_master.jpg"" alt=""Alternate Text"" class=""mw-100"" /></div>
                    </div>
                    <div class=""row container-fluid"">
                        <p class=""font-weight-bold col-sm-8 mb-1"">Áo cầu lông 1</p>
...
<div class=""container py-5"">
    <h1 class=""tab-content"">
        Bán chạy nhất.
        <span class=""text-secondary"">Bán chạy nhấ");
            WriteLiteral(@"t trong tháng</span>
    </h1>
    <section style=""background-color: #eee;"">
        <div class=""container py-3"">
            <div class=""row"">
            ...
            WriteLiteral(@""">400.000</strike>
                ...
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    ...
                    <div class=""row container-fluid"">
                        ...
                        <p class=""font-weight-bold col-sm-4 mb-1"">200.000</p>
                        <p style=""font-size: small;"" class=""col-sm-8"">Loại áo</p>
                        <strike style=""font-size: small;"" class=""col-sm-4"">400.0");
            WriteLiteral(@"00</strike>
                    </div>
                    <p><i class=""bi bi-star-fill""></i> 4.9 (100)</p>
                </div>
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    ...
                    <div class=""row container-fluid"">
                        ...
                        <p class=""font-weight-bold col-sm-4 mb-1"">200.000</p>
                        <p style=""font-size: small;"" class=""col-sm-8"">Loại áo</p>
                        <strike style=""font-size: small;"" class=""col-sm-4"">400.000</str");
            WriteLiteral(@"ike>
                    </div>
                    <p><i class=""bi bi-star-fill""></i> 4.9 (100)</p>
                </div>
            ...
            <div class=""row"">
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    ...
                    <div class=""row container-fluid"">
                        <p class=""font-weight-bold col-sm-8 mb-1"">Áo cầu lông 1</p>
                        <p class=""font-weight-bold col-sm-4 mb-1"">200.000</p>
                        <p style=""font-size: small;"" class=""col-sm-8"">Loại áo");
            WriteLiteral(@"</p>
                        <strike style=""font-size: small;"" class=""col-sm-4"">400.000</strike>
                    </div>
                    <p><i class=""bi bi-star-fill""></i> 4.9 (100)</p>
                ...
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
                    ...
                    <div class=""row container-fluid"">
                        ...
                        <p style=""font-size: small;"" class=""col-sm-8"">Loại áo</p>
 ");
            WriteLiteral(@"                       <strike style=""font-size: small;"" class=""col-sm-4"">400.000</strike>
                    </div>
                    <p><i class=""bi bi-star-fill""></i> 4.9 (100)</p>
                </div>
                <div class=""col-sm-4 d-flex justify-content-center flex-column"">
    ...
    <div class=""bg-image"">
        ...
        <div class=""mask"">
            <div class=""bottom-0 d-flex align-items-center h-100 text-center justify-content-start"">
               ...
               ");
            WriteLiteral(@"     <div class=""position-relative mx-auto"">
                        <button type=""submit""
                                class=""btn btn btn-dark border-2 border-secondary position-absolute rounded-pill text-white h-auto w-45""
                                style=""left: 40%;"">
                            Mua ngay
